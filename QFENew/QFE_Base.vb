...
Public Class QFE_Base
    ...
    Public Structure SeriesStats
        ...
        Public bEntryInd As IndicatorStats, sEntryInd As IndicatorStats
    ...
    Public Structure Parameters
        ...
        Public sZScore As Pivot, BandH As Pivot, Buy As Pivot, Sell As Pivot
        ...
        Public bEntry As Pivot, sExecute As Pivot, bTrigger As Pivot, sEntry As Pivot
    ...
    Public Structure Trades
        ...
        Public bActual As Sig, bTrigger As Sig, sExecute As Sig, bSignal As Sig, sSignal As Sig
    ...
    Public Sub Put_Trades11(ByRef R As Results, ByRef TS() As Trades)
        ...
        With TS(1)
           ...
           "','" & 0 &
            ...
            "','" & R.SP.bTD1.Text &
            "','" & R.SP.bTD2.Text & "-" &
            "','" & Strings.Left(R.SP.bEntry.Text1, 13) & Format$(0, "000.000") &
            "','" & op(TS(1).bDayNo) &
            "','" & hi(TS(1).bDayNo) &
            "','" & lo(TS(1).bDayNo) &
            "','" & cl(TS(1).bDayNo) &
    ...
    Public Function SetLastDayTrade1(ByRef R As Results, ByRef TS() As Trades, ByRef trd As Trades, ByRef thisDay As Integer) As Boolean
        With trd
            ...
            Else
                .bentry.qHiti = 0
            End If
            .bentry.qHit = .bTrigger.qHit And .bentry.qHit And .bDOW.qHit And .bTD1.qHit And .bTD2.qHit And .bZscore.qHit
            If .bentry.qHit Then
                .bentry.qHiti = 255
            Else
                .bentry.qHiti = 0
    ...
    Public Function SetLastDayTradenozzz1(ByRef R As Results, ByRef TS() As Trades, thisDay As Integer) As Boolean
        ...
        With lastDayTrade
            ...
            End If
            .bentry.Text = .bEntry.Text
            SetLastDayTradenozzz1 = lastDayTrade.bentry.qHit
        End With
    End Function
    ...
    Public Sub DoBHTrades_OpnCl1(ByRef R As Results, ByRef TS() As Trades)
        ...
        With R
            ...
            For xline = Counters.start_Day To Counters.end_day
                ...
                .SS.Main.bEntryInd.Hits = .SS.Main.bEntryInd.Hits + 1
                TS(.SS.Main.Trades).Profit0 = TS(.SS.Main.Trades).sAmt - TS(.SS.Main.Trades).bAmt
                TS(.SS.Main.Trades).Profit1 = TS(.SS.Main.Trades).Profit0
                TS(.SS.Main.Trades).Profit2 = TS(.SS.Main.Trades).Profit1
                TS(.SS.Main.Trades).Profit3 = TS(.SS.Main.Trades).Profit2
...
exxit:
    ...
    Public Sub Delete_Tables1()
        ...
        With OleDBC
            .Connection = conn2
            .CommandText = "DELETE FROM Totals"
            .ExecuteNonQuery()
        End With
        With OleDBC
            .Connection = conn2
